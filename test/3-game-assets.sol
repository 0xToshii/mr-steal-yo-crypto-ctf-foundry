...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        GameExploiter gameExploiter = new GameExploiter(address(assetWrapper));
        gameExploiter.runExploit(0,address(swordAsset));
        gameExploiter.runExploit(0,address(shieldAsset));
