...
import {BunnyExploiter} from "src/fatality/BunnyExploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        BunnyExploiter exploiter = new BunnyExploiter(
            address(uniRouter),
            uniFactory.getPair(address(usdc),address(dai)),
            uniFactory.getPair(address(bnb),address(dai)),
            address(usdcBnbPair),
            address(bunny),
            address(usdc),
            address(bnb),
        ...
        exploiter.runExploit(890_000e18,2_999e18);
