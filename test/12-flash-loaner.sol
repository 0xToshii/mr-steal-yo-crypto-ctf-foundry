...
import {FlashExploiter} from "src/flash-loaner/FlashExploiter.sol";
...
contract Testing is Test {
    ...
    function testChallengeExploit() public {
        ...
        FlashExploiter exploiter = new FlashExploiter();
        exploiter.runExploit(address(uniPair),address(flashLoaner));
